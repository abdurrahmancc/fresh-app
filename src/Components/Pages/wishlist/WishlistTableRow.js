    ...
    <>
      <Tr className={"border-y"}>
        ...
        <Td className="text-lg my-5 sm:my-0">
          <div className=" sm:text-center sm:text-[1.2vw] lg:text-lg font-semibold py-5">
            <span
        ...
        <Td className="text-lg">
          <div className="py-5">
            <button
              ...
              className="py-2 sm:mx-auto px-6 lg:py-2 lg:px-6 sm:px-3 sm:py-1  sm:text-[1.5vw] lg:text-sm rounded-full border-primary btn-animate hover:text-white capitalize border flex items-center gap-2"
            >
              <MdAddShoppingCart />
