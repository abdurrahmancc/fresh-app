            ...
            <div className="pl-14 flex justify-center flex-col h-full">
              <div className="py-10">
                ...
                <Fade bottom delay={600}>
                  <button className="py-3 btn-animate btn px-6 text-neutral font-bold border-none rounded-sm btn-primary ">
                    Shop Now
                  </button>
                </Fade>
              </div>
      ...
      >
        <div className="pl-14 flex justify-center flex-col h-full">
          <div className="py-10">
            ...
            <Fade bottom delay={600}>
              <button className="py-3 btn-animate btn px-6 text-neutral border-none rounded-sm font-bold  btn-primary ">
                Shop Now
              </button>
            </Fade>
          </div>
